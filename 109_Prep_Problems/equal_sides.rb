...
Input: An integer array of length 0 < arr < 1000. The numbers in the array can
...
Note: If you are given an array with multiple answers, return the lowest correct
index.
